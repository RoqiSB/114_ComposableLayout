package com.example.activity2kotlin
...
import com.example.activity2kotlin.ui.theme.Activity2kotlinTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Activity2kotlinTheme {
...
fun TampilLayar(pesan: String, dari:String){
    val image = painterResource(R.drawable.estetik)
    Box {
        Image(
            painter = image,
